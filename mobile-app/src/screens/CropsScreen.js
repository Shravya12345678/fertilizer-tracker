...
//   useEffect(() => {
//     cropsAPI.getAll().then(res => setCrops(res.data.data.crops));
//   }, []);
...
//         renderItem={({ item }) => (
//           <TouchableOpacity onPress={() => navigation.navigate('CropDetail', { cropId: item._id })}>
//             <Card style={styles.card}>
//               <Text style={styles.name}>{item.cropName}</Text>
//               <Text style={styles.type}>{item.cropType} • {item.fieldSize} Acres</Text>
//             </Card>
//           </TouchableOpacity>
//         )}
//       />
//       <TouchableOpacity style={styles.fab} onPress={() => navigation.navigate('AddCrop')}>
...
//   type: { color: '#6b7280' },
//   fab: { position: 'absolute', bottom: 20, right: 20, backgroundColor: '#16a34a', width: 56, height: 56, borderRadius: 28, alignItems: 'center', justifyContent: 'center', elevation: 5 },
