...
//   const [form, setForm] = useState({ cropName: '', cropType: '', fieldSize: '', soilNPK: { n: '', p: '', k: '' } });
...
//       <Input label="Crop Name" placeholder="e.g. North Wheat Field" onChangeText={(v) => setForm({...form, cropName: v})} />
//       <Input label="Crop Type" placeholder="e.g. Wheat" onChangeText={(v) => setForm({...form, cropType: v})} />
//       <Input label="Field Size (Acres)" keyboardType="numeric" onChangeText={(v) => setForm({...form, fieldSize: v})} />
//       <Button title="Save Crop" onPress={handleSubmit} loading={loading} />
//     </ScrollView>
//   );
// }

// const styles = StyleSheet.create({ container: { padding: 20, backgroundColor: '#fff' } });
...
//   const handleSubmit = async () => {
//     if (!formData.cropName || !formData.fieldSize) {
//       Alert.alert('Error', 'Please fill all required fields');
//       return;
//     }

//     if (!formData.soilData.N || !formData.soilData.P || !formData.soilData.K || !formData.soilData.pH) {
//       Alert.alert('Error', 'Please fill all soil data fields');
//       return;
//     }
...
//         ...formData,
//         plantingDate: formData.plantingDate || new Date().toISOString(),
//       });
...
//               setFormData({
//                 ...formData,
//                 soilData: { ...formData.soilData, N: text },
//               })
//             }
...
//               setFormData({
//                 ...formData,
//                 soilData: { ...formData.soilData, P: text },
//               })
//             }
//             keyboardType="number-pad"
//           />
...
//               setFormData({
//                 ...formData,
//                 soilData: { ...formData.soilData, K: text },
//               })
//             }
//             keyboardType="number-pad"
//           />
...
//               setFormData({
//                 ...formData,
//                 soilData: { ...formData.soilData, pH: text },
//               })
//             }
//             keyboardType="decimal-pad"
//           />
